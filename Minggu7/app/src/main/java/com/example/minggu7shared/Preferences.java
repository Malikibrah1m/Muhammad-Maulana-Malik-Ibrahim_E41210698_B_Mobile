...
public class Preferences {
    ...
    public static void setKeyUsernameSedangLogin(Context context, String username){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
    ...
    public static void setKeyStatusSedangLogin(Context context, boolean status){
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putBoolean(KEY_STATUS_SEDANG_LOGIN, status);
        editor.apply();
    }
    public static boolean getKeyStatusLSedangLogin(Context context){
